...
class CallsheetModalInsert extends StatelessWidget {
  CallsheetBloc bloc;
            ...
            builder: (context, state) {
              if (thisBloc.customer == null) {
                if (bloc.customer != null) {
                  thisBloc.add(
                    CallsheetSetForm(customer: bloc.customer),
                  );
                }
              }
              if (thisBloc.group == null) {
                if (bloc.group != null) {
                  thisBloc.add(
                    CallsheetSetForm(group: bloc.group),
                  );
                }
              }
                            ...
                            Column(
                              children: [
                                CustomField(
                                  ...
                                  onReset: () {
                                    thisBloc.add(
                                      CallsheetResetForm(naming: true),
                                    );
                                  },
                                ),
                                const SizedBox(height: 20),
                                ...
                                BlocBuilder<CustomerBloc, CustomerState>(
                                  ...
                                  builder: (context, stateCust) {
                                    ...
                                    return FieldInfiniteScroll(
                                      ...
                                      onReset: () {
                                        thisBloc.add(
                                          CallsheetResetForm(customer: true),
                                        );
                                      },
                                      onRefreshReset: () {
                                        thisBloc.search = "";
